      ...
      <div className="banner">
        <div className="row align-items-end">
            ...
            <h1 className="color-gray-50 mt-20 mb-20 wow animate__animated animate__fadeInUp">I’m
              <Typewriter
                options={{
                  ...
                  strings: ['Duc Tin', 'Software Engineer', 'Vua Hải Tặc'],
                  autoStart: true,
                  loop: true,
                }}
              />
          ...
          <div className="col-lg-6 text-center">
            <div className="banner-img position-relative wow animate__animated animate__fadeIn"><img src="assets/imgs/v_ductin.png" alt="Genz" />
